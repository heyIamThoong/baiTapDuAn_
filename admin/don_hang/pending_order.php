...
<div class="col-12">
    <div class="bg-light rounded h-100 p-4">
        <h6 class="mb-4" style="font-size: 40px;">Danh sách đang xử lí</h6>
        <div class="table-responsive">
            <table class="table">
                ...
                <tbody>
                    <?php
                   $fetch_order = select_order_pending();
                       ...
                       foreach($fetch_order as $order) { ?>
                            ...
                            <td>
                                <form action="" method="post">
                                    ...
                                    <a href="index.php?action=order_pending&delete=<?= $order['order_code'] ?>" onclick="return confirm('delete this order?');">Xóa</a>
                                </form>
                            </td>
                            </tr>
