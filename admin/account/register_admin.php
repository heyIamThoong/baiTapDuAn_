            ...
            <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <div class="error"><?= (isset($thongbao))? $thongbao : "" ; ?></div>
                        <div class="thanhcong"><?= (isset($thanhcong))? $thanhcong : "" ; ?></div>
                        <form action="" method="post">
                            <div class="form-floating mb-3">
                                <input type="text" name="username" class="form-control" id="floatingText" placeholder="jhondoe" value="">
                                <label for="floatingText">Username</label>
                                <p style="color:red;"><?= (isset($error['username']))? $error['username'] : ''; ?></p>
                            ...
                            <div class="form-floating mb-4">
                                <input type="password" name="cpass" class="form-control" id="floatingPassword" placeholder="Confirm Password">
                                <label for="floatingPassword">Confirm password</label>
                                <p style="color:red;"><?= (isset($error['cpass']))? $error['cpass'] : ''; ?></p>
                            </div>
                            ...
                            <button type="submit" class="btn btn-primary py-3 w-100 mb-4" name="add_admins">Sign Up</button>
                        </form>
                        <p class="text-center mb-0">Already have an Account? <a href="index.php?action=login_admin">Sign In</a></p>
                    </div>
                </div>
            </div>
        </div>
