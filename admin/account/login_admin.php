            ...
            <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <div class="thongbao"><?= (isset($thongbao))? $thongbao : '' ?></div>
                        <form action="index.php?action=login_admin" method="post">
                            <div class="form-floating mb-3">
                                <input type="text" name="name" class="form-control" id="floatingInput" placeholder="name@example.com" value="">
                            ...
                            <button type="submit" class="btn btn-primary py-3 w-100 mb-4" name="login_admin">Sign IN</button>
                        </form>
                        <p class="text-center mb-0">Don't have an Account? <a href="index.php?action=register_admin">Sign Up</a></p>
                    </div>
                </div>
            </div>
        </div>
