...
<body>
    ...
    <div class="super_container">
        ...
        <div class="form">
            ...
            <form action="index.php?art=signin" style="border:1px solid #ccc" method="post">
                <div  class="container">
                    <h1>
                        SIGN IN
                    </h1>
                    ...
                    <div class="clearfix">
                        <a href="index.php?art=login">You do not have an account , register ?</a>
                        <!-- <button type="button" class="cancelbtn">Cancel</button> -->
                        <button name="signup" style="text-align : center;" type="submit" class="signup">Sign Up</button>
                    </div>
                </div>
            </form>
        </div>
